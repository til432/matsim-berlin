...
@CommandLine.Command(
		name = "counts-from-vmz-old",
		description = "Create counts from the now deprecated (VMZ) data"
)
@Deprecated
public class CreateCountsFromVMZOld implements MATSimAppCommand {

	private static final Logger log = LogManager.getLogger(CreateCountsFromVMZOld.class);
	...
	public static void main(String[] args) {
		new CreateCountsFromVMZOld().execute(args);
	}
