 ...
 *
 * This class was copied from its original location. It would have been useful if it was public.
 *
 * @author michaz
 * @author rakow
 *
 */
@SuppressWarnings({"CyclomaticComplexity","WhitespaceAfter", "TrailingComment", "TodoComment"})
